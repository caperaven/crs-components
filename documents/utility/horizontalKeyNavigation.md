# Horizontal key navigation

## Introduction
This function enables horizontal key navigation actions on a given element by listening to the Key Up event.  
...
```js
await enableHorizontalKeys(element);
```

## Location
"/components/lib/horizontal-key-navigation.js"